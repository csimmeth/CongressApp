//
//  senateCommViewController.swift
//  Congress
//
...
class senateCommViewController: UIViewController, UITableViewDataSource,UITableViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        let url = "http://hw811944.us-west-2.elasticbeanstalk.com/a8/index.php?keyword=senatec"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "senateCommCell", for: indexPath)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "senateCommSegue", sender: Any?.self)
    }
