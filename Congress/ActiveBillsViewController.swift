...
class ActiveBillsViewController: UIViewController, UITableViewDataSource,UITableViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        let url = "http://hw811944.us-west-2.elasticbeanstalk.com/a8/index.php?keyword=activebills"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "activeBillCell", for: indexPath) as! billCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "billDetailsSegue", sender: Any?.self)
    }
